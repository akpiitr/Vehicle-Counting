...
#Lines
line_up=int(2*(h0/5)+190)
line_down=int(3*(h0/5)+50)

up_limit=int(1*(h0/5)+100)
down_limit=int(4*(h0/5)-20)

print("Pink line y:",str(line_down))
...
while(cap.isOpened()):
    ...
    if ret==True:
        ...
        #frame=cv2.polylines(frame,[pts_L3],False,(255,255,255),thickness=0)
        #frame=cv2.polylines(frame,[pts_L4],False,(255,255,255),thickness=0)
